...
data = {
    ...
    'engagement_name': 'juice-shop sonar scan results ',
    'engagement': 1,
...
if response.status_code == 201:
    print('SonarQube results successfully reimported into DefectDojo')
else:
    print(f'Failed to reimport SonarQube results: {response.status_code} - {response.text}')
